# -*- coding: utf-8 -*-
# Generated by Django 1.11.13 on 2018-08-21 15:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='going_transaction_set', to=settings.AUTH_USER_MODEL)),
                ...
                ('to_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coming_transaction_set', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
